...
| Shipped | `heor-decision-tree` | Researcher-selected finite, non-recurring event paths within one year; source-bound deterministic replay | `heor/decision-tree-plan.json` and hash-bound `heor/results/decision-tree.json` |
