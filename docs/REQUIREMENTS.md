...
- **Status.** 🟡 AI4HEOR 0.1.17 macOS x64 installer and Linux x86_64 `.deb`/`.rpm`
  ...
  and passed all 177 deterministic HEOR tests from their extracted payloads, with all 252
  configured resources matching source bytes. The 0.1.17
