...
- **Status.** 🟡 AI4HEOR 0.1.17 macOS x64 installer and 0.1.16 Linux x86_64 `.deb`/`.rpm`
  ...
  and passed all 170 deterministic HEOR tests from their extracted payloads. The 0.1.17
