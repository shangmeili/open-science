...
- **Status.** 🟡 AI4HEOR 0.1.34 macOS x64 is locally verified from clean commit
  `37cb7d4c502357d49e19a8532a39eb244d8c1d3f`; the cross-built macOS arm64 DMG remains
  ...
  `0beb7b2bcb04a796f256bd8f8528bb787aa77319`. The x64 DMG contains all 286 current
...
| P1-4 | Windows + macOS installers | P1 | 🟡 Partial — current 0.1.34 macOS x64 is locally verified, 0.1.31 arm64 is cross-host content-inspected, and Linux x64 remains verified at 0.1.30; cross-platform work is paused for Intel macOS product acceptance; Windows/native-arm execution and signing remain open |
