...
def _validate(
    ...
    if analysis.get("schema_version") != "0.12.0":
        raise ContractError("analysis schema_version must be 0.12.0")
    if psm.get("schema_version") != "0.4.0":
        raise ContractError("partitioned-survival schema_version must be 0.4.0")
