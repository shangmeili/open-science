# AI4HEOR DOCX/PDF report-export contract
...
Changing either source makes both output files stale.
...
The renderer may replace an earlier app-generated pair only when both files
still match their recorded hashes.

## Review boundary

After generation, the named researcher reviews both formats, including every
number, table, disclosure, limitation, page break, and font substitution in
the DOCX viewer they will actually use. Generation does not establish
