...
- 2–16 explicitly ordered strategies under schema `0.8.0` or portable schema `0.9.0`, or legacy `comparator` and `intervention` roles under schemas `0.1.0`–`0.7.0`;
