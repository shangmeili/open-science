...
**把科研辅助收敛为有边界的 HEOR Skills。** AI4HEOR 的 51 个第一方 Skill
...
与跨平台发布暂停，直到 macOS 路径通过验收。当前源码为 `0.1.48`；已完成隔离首次启动核验的 x64 macOS 交接包仍为
...
以及 0.1.33 对简体中文研究界面和内置 Skill 的重写；当前 51 个内置 Skill 统一使用常见的
