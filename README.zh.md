...
当前验证的 0.1.51 本地 x64 macOS 构建尚未代码签名或 notarize。
...
359 个受控资源和包内 177 项 HEOR 测试，并取代 0.1.50 成为当前候选包。临时应用副本还在已安装应用保持运行时，
...
`AI4HEOR_0.1.51_x64.dmg` 仅用于 Intel Mac 内部测试。打开前先核对 SHA-256
`b06e4cc6f46d52599edbe0ee4e359268840927ddc999fb9021ce4b43abb2e70c`。由于该包尚未
