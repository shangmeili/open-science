...
与跨平台发布暂停，直到 macOS 路径通过验收。当前源码为 `0.1.41`；当前经过验证的 x64 macOS 安装包也是
`0.1.41`。0.1.41 新增有来源绑定、确定性、无宏的研究汇报幻灯生成，生成后的每一页仍等待研究者核对。0.1.40 会在每个能力复核弹窗中先说明这项 Skill 做什么、来自
