...
当前验证的 0.1.38 本地 x64 macOS 构建尚未代码签名或 notarize。
...
81,288,293 字节的
`AI4HEOR_0.1.38_x64.dmg` 的 SHA-256 为
`04c4c8713a9e5e1ef1c480bca76709294fdee79db3c5f1c03044627421fc43c7`，由受控源码提交
`a6940a610e096325886f6a30434ac3d089fcc0c6` 构建。验证确认 334 个受控资源与源码逐字节一致，
...
`AI4HEOR_0.1.38_x64.dmg` 仅用于 Intel Mac 内部测试。打开前先核对上面的 SHA-256。由于该包尚未
