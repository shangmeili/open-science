...
`0.1.41`。当前候选包 `AI4HEOR_0.1.48_x64.dmg` 从 `a4f08f1` 构建，大小为
90,027,878 字节，SHA-256 是
`876f1f875eebbd6c8dcc2167cc9ae6a4552ef63acfb0a91a261b97afabf3da5b`。
独立只读核验已确认 x86-64 架构、0.1.48 身份、OpenCode 1.17.13、uv 0.11.26、
354 个受控资源和包内 177 项 HEOR 测试，并取代 0.1.47 成为当前候选包。由于已安装应用仍在运行，该精确候选包的
